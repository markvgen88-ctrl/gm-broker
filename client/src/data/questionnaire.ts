...
export const questionnaireGraph: QuestionnaireGraph = {
  ...
  // дохода нет вовсе — как и в ветке f_unofficial_q_2b, клиент идёт по
  // цепочке вопросов про остаток/платежи/МФО/крупнейший кредит, а уже
  // оттуда — к вопросу про недвижимость (f_property_2), где, при
  // отсутствии подходящего залога, определится отказ.
  f_unofficial_q_2a: {
